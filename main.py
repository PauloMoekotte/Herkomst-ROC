...
geselecteerde_instellingen = st.sidebar.multiselect(
    "MBO Instellingen", 
    instellingen, 
    default=["ROC van Twente", "Zone.college"] if "ROC van Twente" in instellingen else instellingen[:2]
)
...
with tab2:
    ...
    fig_vo = px.bar(
        ...
        title="Top 15 Toeleverende Scholen (Geselecteerde jaren/instellingen)",
